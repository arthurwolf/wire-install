...
module.exports = class Remote {
    ...
    ssh(command) {
        const to_run = `ssh -i /usr/src/app/ssh/wire-demo -o "StrictHostKeyChecking=no" -o "BatchMode=yes" ${this.options.user}@${this.options.ip} ${command} `;
        // TODO: Make this verbosity a command line option
        //console.log("# command: " + to_run);
